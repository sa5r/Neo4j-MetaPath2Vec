...
See link:{root}/main/java/metapath2vec/GetRelationshipTypes.java[`GetRelationshipTypes.java`] and the link:{root}/test/java/metapath2vec/GetRelationshipTypesTests.java[`GetRelationshipTypesTests.java`].
...
See link:{root}/main/java/metapath2vec/Join.java[`Join.java`] and the link:{root}/test/java/metapath2vec/JoinTest.java[`JoinTest.java`].
...
See link:{root}/main/java/metapath2vec/Last.java[`Last.java`] and the link:{root}/test/java/metapath2vec/LastTest.java[`LastTest.java`].
